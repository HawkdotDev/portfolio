      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:flex-1 lg:min-h-0 items-stretch overflow-visible lg:overflow-hidden">
        ...
        <div className="lg:col-span-2 flex flex-col gap-6 lg:gap-4 lg:h-full lg:min-h-0 overflow-visible lg:overflow-hidden">
          ...
          <div className="flex gap-4 items-stretch h-[160px] sm:h-[180px] lg:h-[38%] min-h-0 p-0 overflow-hidden shrink-0 lg:shrink">
            <div className="w-full border-2 border-black relative rounded-sm h-full shadow-[4px_4px_0px_0px_var(--color-accent-glow)] night-lights bg-neutral-800/5 backdrop-blur-sm overflow-hidden flex flex-col justify-between p-4 box-border">
