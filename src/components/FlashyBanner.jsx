...
export default function FlashyBanner() {
  const [hoveredCard, setHoveredCard] = useState(0);

  // Render reactive SVG scene based on hovered card ID
  const renderVisualAnimation = () => {
    switch (hoveredCard) {
      case 0: // Systems Thinker - Pulsing Network Graph
        return (
          <motion.svg
            key="sys"
      ...
      case 1: // Craftsmanship - Drawing Compass Geometry
        return (
          <motion.svg
            key="craft"
      ...
      case 2: // Perpetual Hacker - Scrolling Binary Matrix lines
        return (
          <motion.div
            key="hack"
      ...
      case 3: // The Design Mind - Concentric expanding colored rings
        return (
          <motion.svg
            key="design"
      ...
      <div className="max-w-6xl mx-auto relative z-10 flex flex-col gap-16">
        ...
        <div className="w-full h-[2px] bg-white/10 relative">
          <div className="absolute top-1/2 left-4 px-3 bg-[#141414] text-[10px] text-red-500 font-bold font-mono tracking-widest uppercase -translate-y-1/2">
            IDEA BEHIND THE DESIGN // HOW I THINK & BUILD
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="md:col-span-5 relative min-h-[300px] flex items-center justify-center p-6 bg-neutral-900 border border-white/10 rounded-sm">
            ...
            {/* Reactive Animation Scene Container */}
            ...
            {/* Screen static border marker label */}
        ...
        <div className="flex justify-center border-t border-white/10 pt-12 mt-4 select-none">
