  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="navbar-blend-element text-neutral-800 font-anton uppercase tracking-normal select-none cursor-pointer text-sm sm:text-base md:text-lg transition-opacity hover:opacity-75 z-100"
        ...
        <div className="flex items-center gap-3 sm:gap-4 z-100">
          ...
          >
            ...
            <button
              ...
              className="navbar-blend-element w-6 h-6 sm:w-7 sm:h-7 flex items-center justify-center rounded-full hover:bg-neutral-800/10 transition-colors cursor-pointer text-neutral-800/70 z-100 focus-visible:ring-2 focus-visible:ring-neutral-800 focus:outline-none"
          ...
          <button
            ...
            className="navbar-blend-element w-7 h-7 sm:w-8 sm:h-8 flex items-center justify-center rounded-full hover:bg-neutral-800/10 transition-all duration-300 active:scale-95 cursor-pointer text-neutral-800/70 focus-visible:ring-2 focus-visible:ring-neutral-800 focus:outline-none z-100 relative"
